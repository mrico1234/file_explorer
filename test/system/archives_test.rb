...
class ArchivesTest < ApplicationSystemTestCase
  ...
  test "creating a Archive" do
    ...
    fill_in "Creationdate", with: @archive.creationdate
    fill_in "Location", with: @archive.location
    fill_in "Name", with: @archive.name
    fill_in "String", with: @archive.string
    fill_in "Tamaño", with: @archive.tamaño
